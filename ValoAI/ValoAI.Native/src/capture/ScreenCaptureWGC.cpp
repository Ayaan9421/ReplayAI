...
bool ScreenCaptureWGC::createFramePool() {
    ...
    //m_framePool = Direct3D11CaptureFramePool::Create(d3dDeviceWinRT, DirectXPixelFormat::B8G8R8A8UIntNormalized, 2, size);
    m_framePool = Direct3D11CaptureFramePool::CreateFreeThreaded(d3dDeviceWinRT, DirectXPixelFormat::B8G8R8A8UIntNormalized, 2, size);
